...
export default async function LegalOverview() {
  ...
  return (
    <div className="p-6 space-y-6">
      <LegalSubNav />
      <PageHeader title="Legal & Compliance" subtitle="Documents, GDPR records, contractor agreements, Companies House filings, IP." />
      <section className="grid grid-cols-2 md:grid-cols-5 gap-px bg-border border border-border">
