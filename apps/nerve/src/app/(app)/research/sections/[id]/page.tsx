  ...
  return (
    <div className="p-6">
      ...
      <PageHeader
        ...
        actions={
          editing ? (
            <HeaderLink href={`/research/sections/${section.id}`}>cancel edit</HeaderLink>
          ) : (
            <>
              ...
              <HeaderLink href={`/research/sections/${section.id}?history=${showHistory ? "0" : "1"}`}>
                {showHistory ? "hide" : "show"} history
              </HeaderLink>
              <HeaderLink href={`/research/sections/${section.id}?edit=1`}>edit</HeaderLink>
              <Link
      ...
      {editing ? (
        <SectionForm
          ...
          cancelHref={`/research/sections/${section.id}`}
                ...
                <ul className="divide-y divide-border">
                  {section.literatureLinks.map(({ literature: l }) => (
                    <li key={l.id} className="px-3 py-2">
                      <Link href={`/research/literature/${l.id}`} className="font-mono text-xs text-fg hover:underline">
