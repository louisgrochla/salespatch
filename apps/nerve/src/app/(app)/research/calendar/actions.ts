...
export async function createCalendarItem(formData: FormData) {
  ...
  revalidatePath("/research/calendar");
  redirect(`/research/calendar/${row.id}`);
}
...
export async function updateCalendarItem(id: string, formData: FormData) {
  ...
  revalidatePath("/research");
  revalidatePath("/research/calendar");
  revalidatePath(`/research/calendar/${id}`);
  redirect(`/research/calendar/${id}`);
}
