      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <HeaderPrimary href="/research/literature/new">+ new entry</HeaderPrimary>
          </>
        }
      />
          ...
          <div className="border border-border bg-bg-panel">
            ...
            <ul>
              ...
              {themes.map(([t, n]) => (
                <li key={t}>
                  <Link
                    href={`/research/literature?theme=${encodeURIComponent(t)}`}
            ...
            <ul>
              {[["", "all"], ["supports", "supports"], ["challenges", "challenges"], ["contextualises", "contextualises"]].map(([v, label]) => {
                ...
                return (
                  <li key={v}>
                    <Link
                      href={`/research/literature?${params.toString()}`}
                      className={cn("block px-3 py-1.5 font-mono text-xs hover:bg-bg-hover",
