...
export async function createEvidence(formData: FormData) {
  ...
  revalidatePath("/research/evidence");
  redirect(`/research/evidence/${row.id}`);
}
...
export async function updateEvidence(id: string, formData: FormData) {
  ...
  revalidatePath("/research");
  revalidatePath("/research/evidence");
  revalidatePath(`/research/evidence/${id}`);
  redirect(`/research/evidence/${id}`);
}
