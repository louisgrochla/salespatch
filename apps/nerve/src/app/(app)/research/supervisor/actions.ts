...
export async function createMeeting(formData: FormData) {
  ...
  revalidatePath("/research/supervisor");
  redirect(`/research/supervisor/${row.id}`);
}
...
export async function updateMeeting(id: string, formData: FormData) {
  ...
  revalidatePath("/research");
  revalidatePath("/research/supervisor");
  revalidatePath(`/research/supervisor/${id}`);
  redirect(`/research/supervisor/${id}`);
}
