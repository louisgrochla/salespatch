...
export async function createMethodology(formData: FormData) {
  ...
  revalidatePath("/research/methodology");
  redirect(`/research/methodology/${row.id}`);
}
...
export async function updateMethodology(id: string, formData: FormData) {
  ...
  revalidatePath("/research");
  revalidatePath("/research/methodology");
  revalidatePath(`/research/methodology/${id}`);
  redirect(`/research/methodology/${id}`);
}
