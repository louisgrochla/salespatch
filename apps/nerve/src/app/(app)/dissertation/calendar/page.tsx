  ...
  return (
    <div className="p-6">
      ...
      <PageHeader
        ...
        actions={<HeaderPrimary href="/dissertation/calendar/new">+ new milestone</HeaderPrimary>}
      />
              ...
              {items.map((i) => {
                ...
                return (
                  <tr key={i.id} className="cursor-pointer">
                    <td>
                      <Link href={`/dissertation/calendar/${i.id}`} className="text-fg hover:underline">
                        {i.milestone}
                      </Link>
                    </td>
