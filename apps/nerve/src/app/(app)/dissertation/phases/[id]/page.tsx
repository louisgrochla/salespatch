  ...
  return (
    <div className="p-6">
      ...
      <PageHeader
        ...
        actions={
          editing ? (
            <HeaderLink href={`/dissertation/phases/${phase.id}`}>cancel edit</HeaderLink>
          ) : (
            <>
              ...
              <HeaderLink href={`/dissertation/phases/${phase.id}?edit=1`}>edit</HeaderLink>
              <Link href="/dissertation/phases" className="font-mono text-2xs uppercase tracking-wider text-fg-muted hover:text-fg border border-border hover:border-border-strong px-2 py-1">
                back
              </Link>
            </>
          )
      ...
      {editing ? (
        <PhaseForm action={updateAction} cancelHref={`/dissertation/phases/${phase.id}`} submitLabel="Save changes"
