...
export async function createPhase(formData: FormData) {
  ...
  revalidatePath("/dissertation/phases");
  redirect(`/dissertation/phases/${row.id}`);
}
...
export async function updatePhase(id: string, formData: FormData) {
  ...
  revalidatePath("/dissertation");
  revalidatePath("/dissertation/phases");
  revalidatePath(`/dissertation/phases/${id}`);
  redirect(`/dissertation/phases/${id}`);
}
