  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <PageHeader
        ...
        actions={
          <HeaderLink href="/dissertation/meta">edit metadata</HeaderLink>
        }
      />
          ...
          <div>
            ...
            {sections.length === 0 ? (
              <div className="border border-border bg-bg-panel px-4 py-8 text-center font-mono text-xs text-fg-dim">
                <Link href="/dissertation/sections/new" className="text-accent underline">Create the first chapter</Link>
              </div>
            ) : (
              <div className="border border-border bg-bg-panel">
                <table className="nv-table">
          ...
          <div className="border border-border bg-bg-panel">
            ...
            {calendarUpcoming.length === 0 ? (
              <div className="px-3 py-4 font-mono text-xs text-fg-dim text-center">
                <Link href="/dissertation/calendar/new" className="text-accent underline">+ milestone</Link>
              </div>
            ) : (
              <ul className="divide-y divide-border">
                {calendarUpcoming.map((c) => (
                  <li key={c.id} className="px-3 py-2">
                    <Link href={`/dissertation/calendar/${c.id}`} className="font-mono text-xs text-fg hover:underline">
                      {c.milestone}
                    </Link>
