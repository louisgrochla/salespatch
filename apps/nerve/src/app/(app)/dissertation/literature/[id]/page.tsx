  ...
  return (
    <div className="p-6">
      ...
      <PageHeader
        ...
        actions={
          editing ? (
            <HeaderLink href={`/dissertation/literature/${e.id}`}>cancel edit</HeaderLink>
          ) : (
            <>
              ...
              <HeaderLink href={`/dissertation/literature/${e.id}?edit=1`}>edit</HeaderLink>
              <Link href="/dissertation/literature"
      ...
      {editing ? (
        <LiteratureForm
          action={updateAction}
          cancelHref={`/dissertation/literature/${e.id}`}
                ...
                <ul className="divide-y divide-border">
                  {e.sectionLinks.map(({ section: s }) => (
                    <li key={s.id} className="px-3 py-2">
                      <Link href={`/dissertation/sections/${s.id}`} className="font-mono text-xs text-fg hover:underline">
                        {s.chapter}
                      </Link>
                    </li>
                  ))}
