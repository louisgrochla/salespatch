  ...
  return (
    <div className="p-6">
      ...
      <PageHeader
        ...
        actions={
          editing ? (
            <HeaderLink href={`/dissertation/methodology/${d.id}`}>cancel edit</HeaderLink>
          ) : (
            <>
              ...
              <HeaderLink href={`/dissertation/methodology/${d.id}?edit=1`}>edit</HeaderLink>
              <Link href="/dissertation/methodology" className="font-mono text-2xs uppercase tracking-wider text-fg-muted hover:text-fg border border-border hover:border-border-strong px-2 py-1">
                back
              </Link>
            </>
          )
      ...
      {editing ? (
        <MethodologyForm action={updateAction} cancelHref={`/dissertation/methodology/${d.id}`} submitLabel="Save changes" initial={d} />
      ) : (
