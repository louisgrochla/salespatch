  ...
  return (
    <div className="p-6">
      ...
      <PageHeader
        ...
        actions={
          editing ? (
            <HeaderLink href="/dissertation/meta">view</HeaderLink>
          ) : (
            <>
              <HeaderLink href={`/dissertation/meta?history=${showHistory ? "0" : "1"}`}>
                {showHistory ? "hide" : "show"} history
              </HeaderLink>
              <HeaderLink href="/dissertation/meta?edit=1">edit</HeaderLink>
            </>
          )
        }
      />
